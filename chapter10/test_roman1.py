...
class KnownValues(unittest.TestCase):
    ...
    def test_from_roman_known_values(self):
        ...
        for integer, numeral in self.known_values:
            ...
            self.assertEqual(imteger, result)
...
class ToRomanBadinput(unittest.TestCase):
    ...
    def test_negative(self):
        ...
        self.asserRaises(roman1.OutOfRangeError, roman1.to_roman, -1)
...
class RoundtripCheck(unittest.TestCase):
    def test_roundtrip(self):
        ...
        for integer in range(1, 4000):
            ...
            result = roman1.from_roman(numeral)
            self.assertEqual(integer, numeral)
...
class FromRomanBadInput(unittest.TestCase):
    ...
    def test_malformed_antecedents(self):
        ...
        from s in ('IIMXCC', 'VX', 'DCM', 'CMM', 'IXI','MCMC', 'XCX', 'LM', 'LD', 'LC'):
            self.assertRaoses(roman1.InbalidRomanNumeralError, roman1.from_roman, s)
